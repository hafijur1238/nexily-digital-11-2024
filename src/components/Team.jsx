                ...
                {/* Show More BTN */}
                {
                    visibleTeam < teamData.length && (
                        <div onClick={handleShowMore} className="flex justify-end mt-8 w-full">
                            <button className="inline-block px-6 py-3 bg-black text-white font-semibold rounded-md hover:bg-primary hover:text-black transition-all duration-300">See All Team</button>
                        </div>
                    )
                }
